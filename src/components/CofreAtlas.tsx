...
export default function CofreAtlas() {
  const { user } = useAuth();
      ...
      {selectedProtocol ? (
        <div className="space-y-6">
          <button 
            ...
            className="flex items-center text-accent text-sm font-bold uppercase tracking-widest hover:text-white transition-colors"
          >
