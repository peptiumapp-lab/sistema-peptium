...
export default function ProGate({ onBack, onUpgrade, title }: ProGateProps) {
  return (
    <div className="py-24 px-4 flex flex-col items-center justify-center text-center space-y-12 max-w-4xl mx-auto">
      <button 
        onClick={onBack}
        className="flex items-center gap-2 text-xs font-black uppercase tracking-wider text-white/50 hover:text-accent transition-all mx-auto group"
      >
      ...
      <div className="space-y-4">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent text-black text-xs font-black uppercase tracking-wider shadow-[0_0_20px_rgba(0,229,255,0.3)]">
        ...
        <p className="text-white/60 text-xs font-bold uppercase tracking-wider max-w-md mx-auto leading-loose italic">
      ...
      <div className="grid grid-cols-2 gap-x-12 gap-y-4 text-left border-y border-white/15 py-8 w-full max-w-2xl">
        {[
          ...
          <div key={i} className="flex items-center gap-3 text-xs font-black text-white/50 uppercase tracking-wider">
      ...
      <div className="space-y-6 w-full max-w-sm">
        <button 
          onClick={onUpgrade}
          className="w-full py-5 bg-accent text-black rounded-2xl font-black text-xs uppercase tracking-wider transition-all hover:scale-[1.02] active:scale-95 shadow-[0_0_50px_rgba(0,229,255,0.2)] hover:bg-white"
        >
          Seja Peptium Prime
        </button>
        <div className="text-white/60 text-xs font-black uppercase tracking-wider flex items-center justify-center gap-2">
