          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               ...
               <div className="p-6 bg-white/[0.02] border border-white/15 rounded-3xl space-y-2">
                 <span className="text-[9px] font-black text-white/60 uppercase tracking-widest flex items-center gap-2"><Droplets size={10}/> Reconstituição</span>
               ...
               {peptide.dosageProtocol?.titration && peptide.dosageProtocol.titration.length > 0 && (
                 <div className="p-6 bg-white/[0.02] border border-white/15 rounded-3xl space-y-4 col-span-1 md:col-span-2">
                   <span className="text-[9px] font-black text-white/60 uppercase tracking-widest">Plano de Titulação</span>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
               <div className="p-5 border border-white/15 bg-white/[0.01] rounded-2xl">
                 <div className="text-[8px] text-white/60 uppercase tracking-widest mb-1">Meia-Vida</div>
                 <div className="text-sm font-black text-white">{peptide.pharmacologyAndPharmacokinetics?.halfLife || peptide.halfLife || 'N/A'}</div>
               </div>
               <div className="p-5 border border-white/15 bg-white/[0.01] rounded-2xl">
                 <div className="text-[8px] text-white/60 uppercase tracking-widest mb-1">Biodisponibilidade</div>
               ...
               <div className="p-5 border border-white/15 bg-white/[0.01] rounded-2xl">
                 <div className="text-[8px] text-white/60 uppercase tracking-widest mb-1">Pico Clínico</div>
                 <div className="text-sm font-black text-white">{peptide.pharmacologyAndPharmacokinetics?.picoClinico || 'A Definir'}</div>
               </div>
               <div className="p-5 border border-white/15 bg-white/[0.01] rounded-2xl">
                 <div className="text-[8px] text-white/60 uppercase tracking-widest mb-1">Pico Biológico</div>
            ...
            {peptide.pharmacologyAndPharmacokinetics?.metabolism && (
               <div className="p-4 bg-white/[0.01] border border-white/15 rounded-xl">
                 <div className="text-[9px] text-white/60 uppercase tracking-widest mb-1">Metabolismo Neural/Hepático</div>
          ...
          <div className="space-y-6 pt-4">
             ...
             {(!peptide.researchLinks || peptide.researchLinks.length === 0) && (!peptide.pmids || peptide.pmids.length === 0) && (!peptide.scientificEvidence || peptide.scientificEvidence.length === 0) ? (
               <div className="p-6 bg-white/[0.01] border border-white/15 rounded-3xl flex flex-col items-center justify-center text-center space-y-3">
                 ...
                 <div className="text-[10px] font-black text-white/60 uppercase tracking-widest">Base de Estudos em Processamento</div>
                 ...
                 {peptide.sideEffectsAndMitigation.map((se, i) => (
                   <div key={i} className="p-6 bg-[#0a0a0c] border border-white/15 hover:border-rose-500/40 rounded-3xl transition-all duration-300 flex flex-col gap-4 relative overflow-hidden group shadow-2xl">
                     ...
                     <div className="pt-4 border-t border-white/[0.03] relative z-10 mt-auto">
                        ...
                        <p className="text-xs text-white/50 font-mono leading-relaxed bg-[#050505] p-3 rounded-xl border border-white/15 group-hover:border-emerald-500/20 transition-colors shadow-inner pl-4 border-l-2 group-hover:border-l-emerald-500">{se.mitigation}</p>
                     </div>
                   </div>
                 ))}
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
               {[
                 ...
                 <div key={i} className="flex flex-col items-center justify-center p-4 bg-white/[0.02] border border-white/15 rounded-2xl space-y-2">
                   <div className="text-2xl font-black text-white/80">{metric.score}<span className="text-sm text-white/40">/5</span></div>
