        ...
        <div className="space-y-12">
            ...
            {steps.map((step, i) => (
              <div key={i} className="p-8 rounded-3xl bg-secondary/[0.01] border border-white/15 space-y-4">
                <div className="flex items-center justify-between">
                  {step.icon}
                  <span className="text-xs font-black text-white/60 italic">0{i + 1}</span>
                </div>
                <h3 className="text-lg font-black text-white uppercase italic tracking-tight">{step.title}</h3>
                <p className="text-sm text-white/60 leading-loose font-medium">{step.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="p-8 rounded-[32px] bg-red-500/5 border border-red-500/20 flex gap-6">
            ...
            <div className="space-y-2">
              <div className="text-red-400 text-xs font-black uppercase tracking-wider">ALERTA DE SEGURANÇA</div>
          ...
          <div className="space-y-6">
            ...
            <div className="prose prose-invert max-w-none text-white/50 text-sm leading-loose space-y-4">
