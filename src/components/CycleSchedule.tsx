    ...
    <div className={`space-y-6 ${!isStandalone ? "pt-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto" : ""}`}>
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div className="space-y-2">
          ...
          <p className="text-[10px] text-white/40 font-bold uppercase tracking-[0.3em]">Sincronização de meia-vida e faseamento de protocolos</p>
        </div>
      </div>
      ...
      <div className="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-10 backdrop-blur-sm">
        <div className="flex items-center gap-4 border-b border-white/5 pb-6 mb-8">
          <button 
            ...
            className={`px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
              activeTab === 'timeline' ? 'bg-accent text-black' : 'bg-white/5 text-white/40 hover:bg-white/10'
            }`}
          >
            Linha do Tempo
          </button>
          <button 
            ...
            className={`px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 ${
              activeTab === 'active' ? 'bg-accent text-black' : 'bg-white/5 text-white/40 hover:bg-white/10'
            }`}
          >
        ...
        {activeTab === 'timeline' && (
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-6 text-[10px] uppercase font-bold text-white/40 mt-6 bg-black/20 p-4 rounded-xl">
              ...
              <div className="flex items-center gap-2"><div className="w-3 h-3 rounded bg-white/5 border border-white/5"></div> Off-Cycle</div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'active' && (
          <div className="grid gap-4">
            <div className="bg-black/30 border border-white/10 rounded-2xl p-6 flex items-center justify-between group hover:border-accent/30 transition-all">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-white/40 font-bold tracking-widest uppercase">Reparo Tecidual e Cicatrização</p>
                </div>
              </div>
              <div className="text-right">
                <div className="text-sm font-black text-accent">DIA 14 / 30</div>
                <div className="text-[9px] text-white/40 font-bold uppercase tracking-widest mt-1">Saturação 85%</div>
              </div>
            </div>
            
            <div className="bg-black/30 border border-white/10 rounded-2xl p-6 flex items-center justify-between opacity-50">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-white/40 font-bold tracking-widest uppercase">Otimização Metabólica</p>
                </div>
              </div>
              <div className="text-right">
                <div className="text-sm font-black text-white/60">CONCLUÍDO</div>
                <div className="text-[9px] text-white/40 font-bold uppercase tracking-widest mt-1">Ciclo de 8 Semanas</div>
              </div>
            </div>
          </div>
        )}
